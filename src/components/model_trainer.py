...
class ModelTrainerConfig:
    ...
    model_congfig_file_path = os.path.join('config', 'model.pkl')
...
class ModelTrainer:
    ...
    def get_best_model(self,
        ...
        try:
            ...
            # To get best model name for the dict
    ...
    def finetune_best_model(self,
        ...
        try:
            ...
            model_param_grid = self.utils.read_yaml_file(self.model_trainer_config.model_congfig_file_path)["model_selection"]["model"][best_model_name]["search_param_grid"]

            grid_search = GridSearchCV(
                best_model_object, param_grid= model_param_grid,
                cv = 5,
                n_jobs= -1,
                verbose= 1
            )
